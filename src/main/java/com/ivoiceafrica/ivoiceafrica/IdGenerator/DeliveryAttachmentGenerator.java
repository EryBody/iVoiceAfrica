...
public class DeliveryAttachmentGenerator implements IdentifierGenerator {
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) 
        ...
        try {
            ...
            ResultSet rs=statement.executeQuery("select count(delivery_attach_id) as Id from delivery_attachments");

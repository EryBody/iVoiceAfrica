...
public class ServiceLanguageGenerator implements IdentifierGenerator {
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) 
        ...
        try {
            ...
            ResultSet rs=statement.executeQuery("select count(sl_id) as Id from service_languages");

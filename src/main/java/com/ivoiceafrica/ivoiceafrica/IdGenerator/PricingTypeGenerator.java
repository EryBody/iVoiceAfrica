...
public class PricingTypeGenerator implements IdentifierGenerator {
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) 
        ...
        try {
            ...
            ResultSet rs=statement.executeQuery("select count(pricing_type_id) as Id from pricing_types");

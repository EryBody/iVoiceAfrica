...
public class WorkOrderAttachmentGenerator implements IdentifierGenerator {
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) 
        ...
        try {
            ...
            ResultSet rs=statement.executeQuery("select count(wo_attach_id) as Id from wo_attachments");

...
public class VoiceCapabilityGenerator implements IdentifierGenerator {
	...
	public Serializable generate(SharedSessionContractImplementor session, Object object) 
        ...
        try {
            ...
            ResultSet rs=statement.executeQuery("select count(voice_id) as Id from voice_capabilities");

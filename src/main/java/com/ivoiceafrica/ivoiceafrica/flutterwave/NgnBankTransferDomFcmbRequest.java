...
public class NgnBankTransferDomFcmbRequest {
	...
	public List<NgnBankTransferDomFcmbRequestMeta> meta;
	...
	public List<NgnBankTransferDomFcmbRequestMeta> getMeta() {
		return meta;
	}

	public void setMeta(List<NgnBankTransferDomFcmbRequestMeta> meta) {
		this.meta = meta;
	}

...
public class GhsBankTransferDataResponse {
	public int id;
	...
	public String toString() {
		return "GhsBankTransferDataResponse [id=" + id + ", account_number=" + account_number + ", bank_code="
				+ bank_code + ", full_name=" + full_name + ", created_at=" + created_at + ", currency=" + currency
				+ ", amount=" + amount + ", fee=" + fee + ", status=" + status + ", reference=" + reference + ", meta="
				+ meta + ", narration=" + narration + ", complete_message=" + complete_message + ", requires_approval="
				+ requires_approval + ", is_approved=" + is_approved + ", bank_name=" + bank_name + "]";
	}

...
public class ZarBankTransferDomResponseData {
	...
	public List<ZarBankTransferDomResponseMeta> meta;
	...
	public List<ZarBankTransferDomResponseMeta> getMeta() {
		return meta;
	}

	public void setMeta(List<ZarBankTransferDomResponseMeta> meta) {
		this.meta = meta;
	}

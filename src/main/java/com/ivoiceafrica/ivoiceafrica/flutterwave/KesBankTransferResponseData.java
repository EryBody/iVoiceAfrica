...
public class KesBankTransferResponseData {
	public int id;
	...
	public List<KesBankTransferResponseMeta> meta;
	...
	public List<KesBankTransferResponseMeta> getMeta() {
		return meta;
	}

	public void setMeta(List<KesBankTransferResponseMeta> meta) {
		this.meta = meta;
	}
	...
	public String toString() {
		return "KesBankTransferResponseData [id=" + id + ", account_number=" + account_number + ", bank_code="

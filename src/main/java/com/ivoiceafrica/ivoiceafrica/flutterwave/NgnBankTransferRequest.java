...
public class NgnBankTransferRequest {
	...
	public String toString() {
		return "NgnBankTransferRequest [account_bank=" + account_bank + ", account_number=" + account_number
				+ ", amount=" + amount + ", narration=" + narration + ", currency=" + currency + ", reference="
				+ reference + ", callback_url=" + callback_url + ", debit_currency=" + debit_currency + "]";
	}

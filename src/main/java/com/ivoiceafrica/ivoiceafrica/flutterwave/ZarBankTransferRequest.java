...
public class ZarBankTransferRequest {
	...
	public List<ZarBankTransferRequestMeta> meta;
	...
	public List<ZarBankTransferRequestMeta> getMeta() {
		return meta;
	}

	public void setMeta(List<ZarBankTransferRequestMeta> meta) {
		this.meta = meta;
	}

	@Override
	public String toString() {
		return "ZarBankTransferRequest [account_bank=" + account_bank + ", account_number=" + account_number
